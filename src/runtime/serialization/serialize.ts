...
import { Expression, ArrayInitializer, ObjectInitializer, ExpressionKind } from "../expressions/mod.ts";
import { Serializable } from "../hash.ts";

export function serialize(declaration: Declaration | Pattern | Expression | ArrayInitializer | ObjectInitializer): Serializable {
  ...
  switch (kind) {
    ...
    case PatternKind.Object:
    {
      ...
      return {
        ...
        keys: !keys
          ...
          : Object
            .entries(keys)
            .reduce<Record<string, Serializable>>((r, [k, v]) => Object.assign(r, { [k]: serialize(v) }), {})
      }
    }
    ...
    case DeclarationKind.NativeImport: {
      ...
      return {
        ...
        moduleUrl,
        names,
        module: serialize(typeof module === 'function'
          ? module()
          : module
        )
      };
