...
import { IModuleDeclaration, Declaration } from "./runtime/declarations/mod.ts";
...
async function argsToSpecials(resolver: Resolver, args: Declaration[]): Promise<Map<string, IModule>> {
...
export function dsl<T>(moduleUrl: string, module: IModuleDeclaration, options?: DslOptions) {
...
export const uffda = (options?: DslOptions) => dsl<IModuleDeclaration>(
