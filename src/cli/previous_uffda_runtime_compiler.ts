/**
 * Frozen snapshot of @justinmchase/uffda@0.1.15 UffdaRuntimeCompiler
 * (TypeScript ModuleDeclaration twin) for the CLI compile lower stage.
 * Embedded via static import so standalone binaries can lower offline.
 * Do not replace with Resolver.import of in-tree runtime.compiler.uff.
 */
