...
const testCases = [
  ...
  { index: 4, lines: ["abc", "xyz"], text: "  abc\n  xyz\n--^", column: 0, line: 1 },
  { index: 5, lines: ["abc", "xyz"], text: "  abc\n  xyz\n---^", column: 1, line: 1 },
  { index: 6, lines: ["abc", "xyz"], text: "  abc\n  xyz\n----^", column: 2, line: 1 },
  { index: 7, lines: ["abc", "xyz"], text: "  abc\n  xyz\n-----^", column: 3, line: 1 },
  { index: 8, lines: ["abc", "xyz", ""], text: "  abc\n  xyz\n  \n--^", column: 0, line: 2 },
  { index: 9, lines: ["abc", "xyz", ""], text: "  abc\n  xyz\n  \n--^", column: 0, line: 2 },
]
